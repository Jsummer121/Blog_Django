        ...
        $.ajax({
            ...
            .done(function (res) {
                ...
                <li style="display:block;"><a href="/news/${one_banner.news_id}/">
                 <img src="${one_banner.imgs_url}" alt="${one_banner.news_title}"></a></li>
              `;
                            tab_content = `<li class="active"></li>`;
                        } else {
                            content = `
              <li><a href="/news/${one_banner.news_id}/"><img src="${one_banner.imgs_url}" alt="${one_banner.news_title}"></a></li>
              `;
                            tab_content = `<li></li>`;
                        }
